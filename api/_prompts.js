...
─ 정보 수집 단계 (턴 1~4) ─
턴1: 인사 + 나이/성별/고민부위 수집. "나이와 성별, 고민 부위를 알려주세요" 식으로.
턴2: 세부 고민 파악. "어떤 부분이 제일 신경 쓰이세요?" (콧대/코끝/비대칭 등)
턴3: 원하는 스타일/느낌. "자연스럽게? 또렷하게? 연예인 참고 있으세요?"
턴4: 이전 시술 경험 확인. "혹시 전에 시술 받아보신 적 있으세요?"
