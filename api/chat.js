import { SYSTEM_PROMPT, SAFETY_MD, loadAreaKnowledge, MODEL, getApiKey, readJson, send } from './_lib.js';
...
export default async function handler(req, res) {
  ...
  const messages = [
    { role: 'system', content: SYSTEM_PROMPT + stepNote + context + safety + kb },
    ...userMessages
  ];
  try {
